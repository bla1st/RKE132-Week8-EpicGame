...
string[] weapon = { "Blaster", "Lightsaber", "Force" };
...
Console.WriteLine($"Today {hero} ({heroHP} HP) with {heroWeapon} saves the battle of Coruscant!");
...
Console.WriteLine($"Today {villain} ({villainHP} HP) with {villainWeapon} tries to take Coruscant!");
...
if (heroHP > 0)
{
    Console.WriteLine($"{hero} saves the Coruscant! ");
}
else if (villainHP > 0)
{
